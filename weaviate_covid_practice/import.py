...
def add_data(batch: Batch, data: dict, created_authors: dict, created_journals: dict, batch_size=100):
    ...
    :param batch_size: number of data objects to put in one batch, defaults to 100
...
#To save time we will only add 1000 articles to weaviate rather then all ~34k.
add_data(client.batch, data[:300], created_authors, created_journals, batch_size=100)